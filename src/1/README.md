Edge detection with CV2. This assignment deals with edge detection of pictures containing text. The script can both detect edges on the original image We_Hold_These_Truths_at_Jefferson_Memorial used in the assignment as well as other image datasets. 
...
![](../../data/1/We_Hold_These_Truths_at_Jefferson_Memorial.JPG)
